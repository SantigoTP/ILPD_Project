...
try:
    data_path = os.path.join(os.getcwd(), '/workspaces/ILPD_Project/src/', 'ILPD_dataset.csv') 
...
desc_cat = df.describe(include='category').T
...
st.image("/workspaces/ILPD_Project/src/target_count.png", caption="Conteo de clases")

#GRafica conteo de generos
st.subheader("=== Conteo de géneros del DataSet ===")
st.image("/workspaces/ILPD_Project/src/gender_count.png", caption="Conteo de géneros")

#GRafica conteo de HeatMap
st.subheader("=== Correlación de Pearson entre variables predictoras ===")
st.image("/workspaces/ILPD_Project/src/heatmap.png", caption="Grafica de correlación de Pearson")

st.subheader("Comparación de los modelos probados")
st.image("/workspaces/ILPD_Project/src/rendimiento_modelos.png", caption="Modelos entrenados")
